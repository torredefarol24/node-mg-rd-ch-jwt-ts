...
describe('Hey API Request', function () {
    it('should return success response on call', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, chai_1.default.request(app_1.default).get('/index')];
                case 1:
                    response = _a.sent();
                    chai_1.default.expect(response.status).to.eql(200);
                    return [2 /*return*/];
            }
        });
    }); });
